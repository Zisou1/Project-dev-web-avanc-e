          ...
          deliveries.map((delivery) => (
            ...
            >
              ...
              <div className="mb-2 font-bold">
                ...
                <span className="font-normal">{delivery.restaurant?.name || ''}</span>
              </div>
              <div className="mb-2 font-bold">
                  ...
                  {Array.isArray(delivery.items) && delivery.items.length > 0
                    ? delivery.items.map((item, idx) => (
                        <span key={item.id || idx}>
                          {item.name}{item.price ? ` (${item.price} DA)` : ''}{idx < delivery.items.length - 1 ? ', ' : ''}
                        </span>
                      ))
                    : 'Aucun'}
                </span>
              ...
              <div className="mb-2 font-bold">
                ...
                <span className="font-normal">{delivery.total_price || delivery.montant} DA</span>
              </div>
              <div className="mb-2 font-bold">
            ...
            {deliveries && deliveries.length > 0 ? (
              deliveries.map((delivery) => (
                <tr key={delivery.id} className="hover:bg-gray-50 relative">
                  ...
                  <td className="px-4 py-4 border-b text-center align-middle font-normal text-lg">{delivery.restaurant?.name || ''}</td>
                  ...
                  <td className="px-4 py-4 border-b text-center align-middle font-normal text-lg">{delivery.total_price || delivery.montant} DA</td>
                  <td className="px-4 py-4 border-b text-center align-middle font-normal text-lg">
