// filepath: /Users/ramiderbal/Projects/ProjectDev/Project-dev-web-avanc-e/client/src/layout/RestaurantLivreurLayout.jsx
import React, { useState, useEffect } from 'react';
import { Outlet, useNavigate, useLocation } from 'react-router-dom';
import { useAuth } from '../context/AuthContext';

const RestaurantLivreurLayout = () => {
    ...
    if (user?.role === 'restaurant') {
      ...
      return [
        ...
        },
        {
          ...
          active: location.pathname.startsWith('/livreur/settings')
        }
      ];
    }
    return [];
  ...
  const panelTitle = user?.role === 'restaurant' ? 'Restaurant Panel' : 'Delivery Panel';
    ...
    <div style={styles.layout}>
      ...
      <nav style={styles.navbar}>
        <div style={styles.navbarLeft}>
          ...
          <h1 style={styles.logo}>{panelTitle}</h1>
        </div>
...
export default RestaurantLivreurLayout;