...
const RestaurantInClient = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            >
              ...
              <div className="px-4 pb-4">
                ...
                <p className="text-xs text-gray-600">
                  {item.price || 'N/A'} <span className="font-semibold">DZD</span>
                </p>
              </div>
              <button
      ...
      {showPopup && (
        <div className="fixed top-8 left-1/2 transform -translate-x-1/2 bg-green-500 text-white px-6 py-3 rounded-xl shadow-lg z-50 text-lg font-semibold animate-bounce">
